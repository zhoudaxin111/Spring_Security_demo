...
public class UserService implements UserDetailsService {
    ...
    static {
        com.gxjzy.pojo.User user1 =  new com.gxjzy.pojo.User();
        user1.setUsername("admin");
        user1.setPassword("$2a$10$ExNL7SCc5kIOkVTiKFrrWusROQr6MpzoPxhIKaQua7qB/2FSQY0HO");
        user1.setTelephone("123");

        com.gxjzy.pojo.User user2 =  new com.gxjzy.pojo.User();
        user2.setUsername("zhangsan");
        user2.setPassword("$2a$10$KsRzP9CVB9JSx5Qpmtf7gOuO3GKWzI17q02Vxdta5K7eVttjWO6Ea");
